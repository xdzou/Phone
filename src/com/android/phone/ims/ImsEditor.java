...
public class ImsEditor extends PreferenceActivity
    ...
    private void loadPreferences() {
        ...
        if (imsCallType == CallDetails.RIL_CALL_TYPE_VOICE) {
    ...
    private void validateAndSetResult() {
        ...
        if (IMS_CALL_TYPE_VIDEO.equalsIgnoreCase(PreferenceKey.CallType.getValue())) {
            mSharedPreferences.setCallType(CallDetails.RIL_CALL_TYPE_VT);
        } else {
            mSharedPreferences.setCallType(CallDetails.RIL_CALL_TYPE_VOICE);
        }
